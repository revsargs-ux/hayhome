...
export const AMENITY_NAMES: Record<string, Partial<Record<LangCode, string>>> = {
  ...
  "Отдельная комната":          { ru:"Отдельная комната",         en:"Private room",                hy:"Առանձin սենյակ",              fr:"Chambre privée",             de:"Privatzimmer",               es:"Habitación privada",          it:"Camera privata",              ar:"غرفة خاصة",         zh:"独立房间",       fa:"اتاق خصوصی" },
