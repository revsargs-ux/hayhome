...
const t: Record<LangCode, Translations> = {
  ...
  en: {
    ...
    welcome: { title: "Welcome to HayHome! 🏔️", subtitle: "Begin your cultural journey", step1title: "Find a Family", step1desc: "Choose an Armenian family that will greet you with warmth and hospitality.", step2title: "Book", step2desc: "Complete your booking in a few clicks, safely and reliably.", step3title: "Immerse in Culture", step3desc: "Live like a local: traditions, cuisine, real stories around a big table.", startBtn: "Start Exploring", skipBtn: "Skip" },
