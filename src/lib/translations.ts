...
const t: Record<LangCode, Translations> = {
  ...
  fr: {
    ...
    auth: { loginTitle: "Se connecter", registerTitle: "Créer un compte", registerSub: "Inscription gratuite", password: "Mot de passe", confirmPassword: "Confirmer le mot de passe", name: "Votre nom", loginBtn: "Connexion", loggingIn: "Connexion...", registerBtn: "S'inscrire", registering: "Inscription...", noAccount: "Pas de compte?", hasAccount: "Déjà un compte?", wantToHost: "Vous voulez accueillir?", wrongCreds: "Email ou mot de passe incorrect", passMismatch: "Les mots de passe ne correspondent pas", minPass: "Minimum 6 caractères", socialOr: "ou", socialAutoCreate: "La connexion via réseau social crée automatiquement un compte" },
  },
  ...
  de: {
    ...
    auth: { loginTitle: "Anmelden", registerTitle: "Konto erstellen", registerSub: "Gast-Registrierung — kostenlos", password: "Passwort", confirmPassword: "Passwort bestätigen", name: "Ihr Name", loginBtn: "Anmelden", loggingIn: "Anmeldung...", registerBtn: "Registrieren", registering: "Registrierung...", noAccount: "Kein Konto?", hasAccount: "Bereits ein Konto?", wantToHost: "Gäste empfangen?", wrongCreds: "Ungültige E-Mail oder Passwort", passMismatch: "Passwörter stimmen nicht überein", minPass: "Mindestens 6 Zeichen", socialOr: "oder", socialAutoCreate: "Die Anmeldung über ein soziales Netzwerk erstellt automatisch ein Konto" },
  },
