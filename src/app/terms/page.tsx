          ...
          <div className="space-y-6 text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <ol className="list-decimal list-inside space-y-2">
                ...
                <li>Бесплатная отмена возможна не позднее чем за 48 часов до заезда.</li>
                <li>Платформа не взимает комиссию с Хозяев первые 12 месяцев.</li>
              </ol>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                настоящих Условий, мошенничества или недобросовестного поведения.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Настоящие Условия регулируются законодательством Республики Армения. Все споры разрешаются
                путём переговоров, при невозможности — в суде по месту регистрации Платформы.
              </p>
            </section>
          </div>
