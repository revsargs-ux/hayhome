...
function ForgotContent() {
  ...
  const T = {
    ...
    sending: { ru: "Отправляем...", en: "Sending...", fr: "Envoi...", de: "Senden...", es: "Enviando...", it: "Invio...", ar: "جارٍ الإرسال...", zh: "发送中...", fa: "در حال ارسال..." },
