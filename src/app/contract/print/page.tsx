...
function Ct(key: string, lang: string): string {
  const T: Record<string, Record<string, string>> = {
    ...
    platform: { ru:"ИП Саргсян Ревик Сергеевич", en:"Individual Entrepreneur Sargsyan Revik Sergeevich", hy:"Սարգսյան Ռեվիկ Սերգեյի ԻԱԱ", fr:"Entrepreneur individuel Sargsyan Revik Sergeevich", de:"Einzelunternehmer Sargsyan Revik Sergeevich", es:"Empresario individual Sargsyan Revik Sergeevich", it:"Imprenditore individuale Sargsyan Revik Sergeevich", ar:"رجل أعمال فردي سارغسيان ريفيك سيرجيفيتش", zh:"个体经营者 Sargsyan Revik Sergeevich", fa:"فرد کارآفرین Sargsyan Revik Sergeevich" },
    ...
    actingAs: { ru:"действующий в качестве индивидуального предпринимателя", en:"acting as an individual entrepreneur", hy:"գործող որպես գրանցված ձեռնարկային", fr:"agissant en tant qu'entrepreneur individuel", de:"handelnd als Einzelunternehmer", es:"actuando como empresario individual", it:"agendo come imprenditore individuale", ar:"كرجل أعمال فردي", zh:"以个体经营者身份", fa:"به عنوان کارآفرین فردی" },
    ...
    together: { ru:"совместно именуемые «Стороны», заключили настоящий Договор о нижеследующем:", en:"hereinafter jointly referred to as the «Parties», have concluded this Agreement:", hy:"միաստակաբանված որպես «Կողմեր», կնքել են այս պայմանագիրը.", fr:"ci-après dénommés conjointement les «Parties», ont conclu le présent Accord:", de:"gemeinsam als «Vertragsparteien» bezeichnet, haben folgenden Vertrag geschlossen:", es:"en adelante denominados conjuntamente las «Partes», han concluido el presente Acuerdo:", it:"di seguito denominati congiuntamente le «Parti», hanno concluso il seguente Accordo:", ar:"المشار إليهما معاً بـ «الطرفان»، وافقا على هذا العقد:", zh:"以下简称为「双方」，订立本协议：", fa:"که در ادامه به صورت مشترک «طرفین» نامیده می‌شوند، این قرارداد را منعقد کرده‌اند:" },
    ...
    s1_3: { ru:"Платформа обеспечивает техническое сопровождение, продвижение и обработку бронирований.", en:"The Platform provides technical support, promotion and booking processing.", hy:"հարթակը ապահովում է տեխնիկական աջակցություն, խթանում և ամրագրումների մշակում.", fr:"La Plateforme assure le support technique, la promotion et le traitement des réservations.", de:"Die Plattform bietet technische Unterstützung, Werbung und Buchungsverarbeitung.", es:"La Plataforma proporciona soporte técnico, promoción y procesamiento de reservas.", it:"La Piattaforma fornisce supporto tecnico, promozione e elaborazione delle prenotazioni.", ar:"توفر المنصة الدعم الفني والترويج ومعالجة الحجوزات.", zh:"平台提供技术支持、推广和预订处理。", fa:"پلتفرم پشتیبانی فنی، تبلیغات و پردازش رزرو را فراهم می‌کند." },
    s2_1: { ru:"Предоставить Партнёру доступ к личному кабинету на платформе.", en:"Provide the Partner with access to the personal account on the platform.", hy:"Տրամադրել գործընկերն հասանելիություն անձնական հաշվին հարթակում.", fr:"Fournir au Partenaire l'accès au compte personnel sur la plateforme.", de:"Dem Partner Zugang zum persönlichen Konto auf der Plattform gewähren.", es:"Proporcionar al Socio acceso a la cuenta personal en la plataforma.", it:"Fornire al Partner l'accesso all'account personale sulla piattaforma.", ar:"توفير للشريك الوصول إلى الحساب الشخصي على المنصة.", zh:"向合作伙伴提供平台上个人账户的访问权限。", fa:"به شریک دسترسی به حساب شخصی در پلتفرم را ارائه دهد." },
    ...
    s4_1: { ru:"Комиссия платформы — 16% от суммы бронирования (15% платформа + 1% банковский перевод).", en:"Platform commission — 16% of the booking amount (15% platform + 1% bank transfer).", hy:"հարթակի միջնորդավճարը՝ ամրագրման գումարի 16%-ը (15%՝ հարթակ + 1%՝ բանկային փոխանցում).", fr:"Commission de la plateforme — 16% du montant de la réservation (15% plateforme + 1% virement bancaire).", de:"Plattformkommission — 16% des Buchungsbetrages (15% Plattform + 1% Banküberweisung).", es:"Comisión de la plataforma — 16% del monto de la reserva (15% plataforma + 1% transferencia bancaria).", it:"Commissione della piattaforma — 16% dell'importo della prenotazione (15% piattaforma + 1% bonifico bancario).", ar:"عمولة المنصة — 16% من مبلغ الحجز (15% منصة + 1% تحويل بنكي).", zh:"平台佣金 — 每笔预订金额的16%（15%平台 + 1%银行转账）。", fa:"کارمزد پلتفرم — 16% مبلغ رزرو (15% پلتفرم + 1% انتقال بانکی)." },
    ...
    s9_2: { ru:"Изменения — по взаимному согласию в письменной форме.", en:"Amendments — by mutual written consent.", hy:"Փոփոխություններ՝ փոխադարձ գրավոր համաձայնությամբ.", fr:"Modifications — par consentement mutuel écrit.", de:"Änderungen — durch beiderseitige schriftliche Zustimmung.", es:"Modificaciones — por consentimiento mutuo por escrito.", it:"Modifiche — con consenso scritto reciproco.", ar:"التعديلات — بموافقة كتابية متبادلة.", zh:"修改 — 经双方书面同意。", fa:"تغییرات — با توافق کتبی متقابل." },
    passport: { ru:"Паспорт", en:"Passport", hy:"Անձնագիր", fr:"Passeport", de:"Reisepass", es:"Pasaporte", it:"Passaporto", ar:"جواز السفر", zh:"护照", fa:"پاسپورت" },
    ...
    phone: { ru:"Тел.", en:"Phone", hy:"Հեռ.", fr:"Tél.", de:"Tel.", es:"Tel.", it:"Tel.", ar:"هاتف", zh:"电话", fa:"تلفن" },
