...
function ResetContent() {
  ...
  const T = {
    ...
    saving: { ru: "Сохраняем...", en: "Saving...", hy: "Պահպանում...", fr: "Enregistrement...", de: "Speichern...", es: "Guardando...", it: "Salvataggio...", ar: "جارٍ الحفظ...", zh: "保存中...", fa: "در حال ذخیره..." },
    doneTitle: { ru: "Пароль изменён!", en: "Password changed!", hy: "Գաղտնաբառը փոխվել է!", fr: "Mot de passe modifié!", de: "Passwort geändert!", es: "¡Contraseña cambiada!", it: "Password modificata!", ar: "تم تغيير كلمة المرور!", zh: "密码已更改！", fa: "رمز عبور تغییر کرد!" },
    doneDesc: { ru: "Теперь вы можете войти с новым паролем.", en: "You can now log in with your new password.", hy: "Այժմ կարող եք մտնել նոր գաղտնաբառով։", fr: "Vous pouvez maintenant vous connecter.", de: "Sie können sich jetzt anmelden.", es: "Ahora puedes iniciar sesión.", it: "Ora puoi accedere.", ar: "يمكنك الآن تسجيل الدخول.", zh: "您现在可以使用新密码登录。", fa: "اکنون می‌توانید با رمز عبور جدید وارد شوید." },
    expired: { ru: "Ссылка устарела или недействительна. Запросите новую.", en: "Link expired or invalid. Request a new one.", hy: "Հղումը ժամկետավոր է կամ անվավենացված։ Խնդրում ենք դիմել նոր։", fr: "Lien expiré. Demandez-en un nouveau.", de: "Link abgelaufen. Neuen anfordern.", es: "Enlace expirado. Solicita uno nuevo.", it: "Link scaduto. Richiedine uno nuovo.", ar: "الرابط منتهي. اطلب رابطاً جديداً.", zh: "链接已过期。请申请新链接。", fa: "لینک منقضی شده. درخواست جدید کنید." },
  };
